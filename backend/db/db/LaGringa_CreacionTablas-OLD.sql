...
CREATE TABLE IF NOT EXISTS `proyecto`.`productos` (
  ...
  INDEX `idx_fk_idRubro` (`idRubro` ASC),
...
ADD COLUMN `sinTACC` CHAR(5) NULL DEFAULT 'n' AFTER `fechaActualizacion`;
...
CREATE TABLE IF NOT EXISTS `proyecto`.`lineasCompra` (
  ...
  INDEX `fk_productos_has_compras_compras1_idx` (`idCompra` ASC),
  INDEX `fk_productos_has_compras_productos1_idx` (`idProducto` ASC),
